        ...
        <div class="container d-flex align-items-center justify-content-between py-2">
            ...
            <nav class="nav_container d-none d-md-block">
                <ul class="d-flex">
                    ...
                    <li><a href="#">ỨNG DỤNG ROSA <i class="fas fa-chevron-down"></i></a>
                        <ul class="submenu">
                            <li><a href="ROSA-SW.php">Phần Mềm ROSA</a></li>
                            <li class="has-submenu">
                                <a href="#">Khóa Học <i class="fas fa-chevron-right"></i></a>
                                <ul class="submenu">
            ...
            <ul class="menu_top_nav">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/courses/Nextcloud.php">PHẦN MỀM QUẢN TRỊ DOANH NGHIỆP</a></li>
                        <li class="has-submenu">
                            <a href="">KHOÁ HỌC<i class="fas fa-chevron-down"style="margin-left: 15px"></i></a></a>
                            <ul class="submenu">
                                <li><a href="/courses/python-course.php">PYTHON CƠ BẢN</a></li>

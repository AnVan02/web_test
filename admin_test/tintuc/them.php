            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-content">
                        ...
                        <div class="input-item form-group"></div>
                            <label for="author"class="d-block">Tab</label>
                            <input id="author" type="text" name="article_title" class="d-block form-control" value="" placeholder="">
                        ...
                        <div class="input-item form-group">
                            <label for="title" class="d-block">Tab</label>
                            <textarea name="text"></textarea>
                        </div>
                        
                        <div class="input-item form-group">
                            <label for="title" class="d-block">Nội dung chính bài viết</label>
                            <textarea name="article_content"img src="blog/uploads/<?php echo $row['article_image'] ?>" class="article__image w-100 h-100" style="width: 100px; height: 100px;" alt="image"></textarea>
                        </div>

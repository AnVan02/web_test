    ...
    if ($_FILES["file"]["error"] == UPLOAD_ERR_OK) {
        try {
            ...
            foreach ($data as $key => $row) {
                ...
                $ngayxuat = trim($row[3] ?? ''); // Giữ nguyên định dạng dd-mm-yyyy
                ...
                // Kiểm tra sự tồn tại của số serial
                ...
                if ($checkStmt->num_rows > 0) {
                    // Cập nhật - giữ nguyên định dạng dd-mm-yyyy
                    ...
                    // Thêm mới - giữ nguyên định dạng dd-mm-yyyy

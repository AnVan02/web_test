...
<div id="simplePopup" class="popup">
        <div class="popup-content">
            ...
            <div class="product-info">
                <table style="border-spacing: 10px 0; border-collapse: separate;">
                    ...
                    <td class="product-details">
                        <img src="<?php echo $thumbnail1; ?>" alt="Product">
                        <div>
                        <span class="product-name" id="payment-title"><?php echo $pcName; ?></span>
                            ...
                            <span class="product-name" id="payment-mini"></span>
            ...
            <div class ="bank-info">
                <p><strong>Tên tài khoản</strong>CÔNG TY TNHH CỔ PHÂN TIN HỌC TOÀN VIỆT </p>
                <p><strong>Số tài khoản</strong>0381000415803</p>
                <p><strong>Ngân hàng</strong>VIETCOMBANK - CHI NHANH THỦ ĐỨC</p>
            </div>

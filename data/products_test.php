...
$amd_ryzen5_4650g -> popup ='
<div class="modal-header">
        <h5 class="modal-title">AMD Ryzen 5 PRO 4650G</h5>
        <button type="button" class="close" data-dismiss="modal">x</button>
    </div>
    <div class="modal-body">
        <img src="../assets/images/ryzen3-4350g.jpg" alt="Ryzen 3 Pro 4350G" style="width: 100%; max-width: 400px; display: block; margin: 10px auto;">
...
$amd_ryzen7_5700g ->popup ='
<div class="modal-header">
        <h5 class="modal-title">AMD Ryzen 7 5700G</h5>
        <button type="button" class="close" data-dismiss="modal">x</button>
    </div>
<div class="modal-body">
    
    <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
        <img src="../assets/images/" alt="B550M-A" style="width: 100%; max-width: 400px; display: block; margin: 10px auto;">
    ...
    <div class="modal-body">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding: 10px; border: 1px solid #ddd;">
                    4866(OC), 4600(O.C.), 4466(OC), 4333(OC), 4133(O.C.), 4400(OC), 4266(O.C.), 4200(OC), 4133(OC), 4400(O.C.)
            ...
            <tr>
                ...
                <td style="padding: 10px; border: 1px solid #ddd;">
                  <br>-  4 x USB 3.2 (tối đa 6)</br>
                  <br>-  2 x USB 2.0 (tối đa 6)</br>
                </td>
            </tr>
            <tr>
...
$morax_3fa -> popup = '  
    ...
    <div class="modal-body">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <img src="../assets/images/case_morax_right.jpg" alt="MORAX 3FA MATX" style="width: 100%; max-width: 400px; display: block; margin: 10px auto;">
    ...
    <div class="modal-body">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tbody>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Kích thước </b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">305(L)*170(W)*350(H)mm.</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Chất liệu</b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">0.45mm SPCC/Plastic ABS</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Khe cắm HDD & SDD</b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">1* HDD /1* SSD/5.25"x1</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Khe cắm HDD & SDD</b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">4 khe</td>
                ...
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Thiết bị kết nối ngoại vi I/O</b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">2 x USB 2.0, 1 x HD Audio</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Quạt tản nhiệt (Mặt trước)</b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">Mặt sau 8cm và mặt phải 12cm (Tùy chọn)</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Chiều cao tản nhiệt CPU tối đa</b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">	150mm</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Chiều dài thẻ VGA tối đa</b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">220mm</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Hỗ trợ bo mạch chủ</b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">MICRO-ATX/Mini-ATX</td>
                </tr>
...
$coolermaster_cmp510 -> popup = '
    ...
    <div class="modal-body">
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
        <img src="../assets/images/case_cmp_right.jpg" alt="ROSA CMP-510" style="width: 100%; max-width: 400px; display: block; margin: 10px auto;">
    ...
    <div class="modal-body">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Hỗ trợ ổ cứng tối đa </b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">2 x SSD 2.5 inch ,2 x HDD 3.5 inch
                ...
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><b>Hỗ trợ tản nhiêt nước </b></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">
                        Kích thước tối đa 220 mm
                    </td>
                </tr>

<?php
$sql_article_list = "SELECT * FROM article ORDER BY article_link DESC";
                    ...
                    <table class="table table-hover table-action">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td>
                                        <a href="?action=article&query=article_edit&article_link=<?php echo $row['article_link'] ?>">
                                            <div class="icon-edit">
                                    ...
                                    <td>
                                        <input type="checkbox" class="checkbox" onclick="testChecked(); getCheckedCheckboxes();" id="<?php echo $row['article_link'] ?>">
                                    </td>

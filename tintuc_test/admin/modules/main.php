<div class="main-panel">
    <div class="content-wrapper" >
        ...
        elseif($action =='banner' && $query == 'banner') {
            include("./modules/banner/nhap.php");
        }
        elseif($action =='user' && $query == 'user') {
            include("./modules/user/them.php");
        }
        elseif($action =='baohanh' && $query == 'baohanh') {
            include("./modules/baohanh/upload.php");
        }
        elseif($action =='xuatbh' && $query == 'xuatbh') {
            include("./modules/xuatbh/xuatfile.php");
        }
        elseif($action =='xuatbh' && $query == 'xuatbh') {
            include("./modules/xuatbh/testfile.php");
        }
        ...
        elseif($action =='article' && $query == 'article_test_order') {
            include("modules/makes/test_order.php");
        }

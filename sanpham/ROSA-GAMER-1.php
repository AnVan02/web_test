                ...
                .spec-name {
                    ...
                    <div class="product-column product-config">
                        <div class="product-header">
                            ...
                            <div>
                            <p style="font-weight: bold" >PC mạnh mẽ cho game thủ đỉnh cao!</p>
                            <p>
                            ...
                            <dl>
                                <p style="font-weight: bold" >🔥 Đồ họa đỉnh cao</p>
                                <p>Hỗ trợ DirectX 12 Ultimate và công nghệ Ray Tracing, khai thác tối đa sức mạnh của VGA để tạo ra hình ảnh sống động, chân thực.</p>
                                <p style="font-weight: bold" >🔥 Tốc độ vượt trội</p>
                                <p>Tận dụng DirectStorage, giảm thời gian tải game đáng kể để bạn vào trận ngay lập tức.</p>
                                <p style="font-weight: bold" >🔥 Tối ưu hiệu suất</p>
                                <p>Chế độ Game Mode ưu tiên tài nguyên cho game, mang lại trải nghiệm mượt mà, không giật lag.</p>
                                <p style="font-weight: bold" >🔥 Kết nối an toàn</p>
                                <p>Bảo mật mạnh mẽ giúp bạn yên tâm khi chơi game online.</p>
                            
                            <p> Với ROSA GAMER Ⅰ, bạn không chỉ chơi game, mà còn trải nghiệm thế giới gaming một cách đẳng cấp!</p>
                            <!--<br><br>-->
                            </div>
                        </div>
                        <!--<h3>Hệ Điều Hành</h3>-->
                ...
                <div id="simplePopup" class="popup">
                    ...
                    <span class="close-btn" onclick="closePopup()">×</span>
                        ...
                        <div class="delivery-method">
                            <labelstyle='font-weight: bold;font-size: 16px;' >Phương thức nhận hàng</label>

...
$pcName = "ROSA OFFICE Ⅰ";

$image_sp = "../assets/images/Rosa Office.jpg";

$thumbnail_list = [ "../assets/images/Rosa Office.jpg",
...
// Create CPU list
$cpu_list = [$amd_ryzen3_3200g,$amd_ryzen3_4350g,$amd_ryzen3_4300g,$amd_ryzen5_4650g];
...
// Create SSD list
$ssd_list = [$kingston_240g_sata,$kingston_480g_sata];
...
$others->price += 1090; // extra


// Default cart (Giỏ hàng mặc định)
$cart_list = [$amd_ryzen3_3200g, // CPU
              $asus_prime_a520,  // MAIN
              $lexar_8g_3200,    // RAM
              $kingston_240g_sata,  // SSD
                ...
                .spec-name {
                    ...
                    <div class="product-column product-config">
                        <div class="product-header">
                            ...
                            <div>
                            <h4>Giải pháp toàn diện cho doanh nghiệp hiện đại!</h4>
                            <p>ROSA OFFICE Ⅰ không chỉ sở hữu cấu hình mạnh mẽ mà còn được cài trang bị <strong>Windows 11 Pro</strong> và <strong>NextCloud</strong>, mang đến một môi trường làm việc an toàn, linh hoạt và hiệu quả hơn bao giờ hết
                            </p><br>
                            
                            <h4>🚀Windows 11 Pro – Hiệu suất và bảo mật vượt trội</h4>
                            <ul>
                                <li><strong>Làm việc thông minh, đa nhiệm mượt mà</strong> với Snap Layouts, Snap Groups.</li>
                                <li><strong>Bảo mật tối đa</strong> với BitLocker, Windows Defender và cơ chế bảo vệ dữ liệu tiên tiến.</li>
                                <li><strong>Hỗ trợ làm việc từ xa linh hoạt</strong> nhờ Remote Desktop và Azure Active Directory.</li>
                                <li><strong>Tích hợp AI Copilot</strong>, giúp tối ưu hóa công việc hằng ngày và tăng hiệu suất làm việc.</li>
                            </ul>
                        
                            <h4>☁️NextCloud – Giải pháp lưu trữ và cộng tác an toàn</h4>
                            <ul>
                                <li><strong>Truy cập và đồng bộ dữ liệu dễ dàng</strong> trên mọi thiết bị, giúp làm việc từ xa hiệu quả.</li>
                                <li><strong>Bảo mật thông tin tối đa</strong>, kiểm soát quyền truy cập linh hoạt.</li>
                                <li><strong>Tích hợp liền mạch với các công cụ văn phòng</strong>, hỗ trợ làm việc nhóm hiệu quả.</li>
                            </ul>
                            
                            <a href="https://nextcloud.com/" target="_blank">Khám phá về Nextcloud ></a>
...
<script>
    ...
    <div class="specs-container">
        ...
        <h2>Tổng Quan Sản Phẩm</h2>
            <p style="color:black;">ROSA OFFICE Ⅰ mang đến một môi trường làm việc hiện đại, an toàn và hiệu quả. 
            Hệ điều hành này không chỉ tối ưu hóa hiệu suất với giao diện đa nhiệm mượt mà mà còn tăng cường bảo mật dữ liệu và hỗ trợ truy cập từ xa. 
            Kết hợp cùng cấu hình ổn định, đây là sự lựa chọn lý tưởng để giúp bạn hoàn thành mọi nhiệm vụ công việc nhanh chóng và chuyên nghiệp.
            </p>
            ...
            <!--<h3>Nâng Cao Năng Suất Làm Việc Với Màn Hình AOC 22” 22B30HM23/74</h3>-->

            <!--<img src="../assets/images/aoc22.png" alt="PC Gaming XYZ" style="width: 100%; max-width: 400px; display: block; margin: 20px auto;">-->


            <!--<p style="color:black;"> Khi mua ROSA OFFICE Ⅰ, bạn sẽ nhận ngay AOC 21.5” LCD (22B30HM23/74) với các tính năng nổi bật như:</p>-->

            <!--<ul>-->
            <!--    <p>• <b>Độ phân giải Full HD (FHD)</b> cho hình ảnh sắc nét, rõ ràng, giúp dễ dàng xem tài liệu, trình chiếu, và làm việc với các ứng dụng đa nhiệm.</p>-->
            <!--    <p>• <b>Tấm nền VA</b> cung cấp màu sắc sống động, góc nhìn rộng, lý tưởng cho công việc đòi hỏi độ chính xác màu sắc.</p>-->
            <!--    <p>• <b>Tốc độ làm mới 120Hz và thời gian phản hồi 1ms</b>, mang lại trải nghiệm mượt mà khi làm việc với các ứng dụng đồ họa hoặc khi cần xử lý công việc nhanh chóng.</p>-->
            <!--    <p>• <b>Kết nối linh hoạt</b> với 1x Dsub và 1x HDMI, dễ dàng kết nối với các thiết bị khác.</p>-->
            <!--</ul>-->
            <!--<p style="color:black;"> Màn hình AOC này sẽ giúp cải thiện năng suất làm việc nhờ vào không gian làm việc rộng rãi và trải nghiệm hình ảnh chất lượng cao, giúp bạn làm việc lâu dài mà không bị mỏi mắt.</p>-->

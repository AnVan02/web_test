...
// Create CPU list
$cpu_list = [$intel_i3_12100,$intel_i5_14400,$intel_i7_12700];

// Create MAINBOARD list
$main_list = [$asus_prime_h610];
                ...
                .spec-name {
                    ...
                    <div class="product-column product-config">
                        <div class="product-header">
                            ...
                            <div>
                            <p style="font-weight: bold">Rosa Office II là lựa chọn lý tưởng cho doanh nghiệp vừa và nhỏ, cá nhân cần giải pháp máy tính tiết kiệm nhưng vẫn đáp ứng nhu cầu xử lý công việc hàng ngày</p>
                            <br>
                            <p>
                                Với cấu hình cân bằng và tiết kiệm, PC văn phòng Rosa Office II sử dụng CPU Intel Core i3-12100 (thế hệ 12) mang đến hiệu năng ổn định nhờ 4 lõi và 8 luồng, xử lý mượt mà các tác vụ văn phòng cơ bản đến đa nhiệm nhẹ. Mainboard H610 giúp tối ưu chi phí nhưng vẫn đáp ứng đầy đủ nhu cầu của một bộ máy tính văn phòng tầm trung . RAM DDR4  giúp tăng tốc độ xử lý và đa nhiệm, kết hợp cùng SSD 256GB M.2 PCIe cho khả năng khởi động máy, mở ứng dụng và truy xuất dữ liệu nhanh chóng, đảm bảo quy trình làm việc liền mạch.
                                Thiết kế tối ưu hóa cho hiệu quả năng lượng và độ bền, từ soạn thảo, quản lý dữ liệu đến hội họp trực tuyến.                            
                            <br><br>
                            </div>
                        </div>
                        <!--<h3>Hệ Điều Hành</h3>-->

...
$thumbnail_list = ["../assets/images/nuc13_right.webp",
                   "../assets/images/nuc13_front.webp",
                   "../assets/images/nuc13_back.webp"
...
// Create MINIPC list
$minipc_list = [$minipc_nuc13i3,$minipc_nuc13i5,$minipc_nuc13i7];
...
$cart_list = [$minipc_nuc13i3, // MINIPC
...
<head>
    ...
    function updateDisplay(){
        ...
        if (cart.has('minipc')){
            ...
            document.getElementById('table_port_front').innerHTML = cart.get('minipc').note.port_front;
            document.getElementById('table_port_rear').innerHTML = cart.get('minipc').note.port_rear;
                ...
                .spec-name {
                    ...
                    <div class="product-column product-config">
                        <div class="product-header">
                            ...
                            <br>
                            ROSA NUC13 PC là sự lựa chọn lý tưởng cho văn phòng và nhu cầu sử dụng đa mục đích, nhờ sự linh hoạt và hiệu suất vượt trội từ các tùy chọn CPU thế hệ mới nhất. Với Intel Core i3-1315U, máy đáp ứng tốt các công việc văn phòng cơ bản và duyệt web nhẹ nhàng. Intel Core i5-1340P mang lại hiệu suất đa nhiệm vượt trội, lý tưởng cho các tác vụ văn phòng nâng cao, bao gồm xử lý dữ liệu và làm việc với nhiều ứng dụng cùng lúc. Đối với những yêu cầu xử lý phức tạp hơn, Intel Core i7-1360P cung cấp hiệu năng mạnh mẽ, phù hợp cho các tác vụ sáng tạo và các ứng dụng chuyên sâu.
                            <br>
                            Thiết kế nhỏ gọn của NUC13 giúp tiết kiệm không gian làm việc, trong khi khả năng kết nối hiện đại hỗ trợ đầy đủ các thiết bị ngoại vi và mạng nhanh chóng. Với ROSA NUC13 PC, bạn sẽ có một hệ thống hiệu quả, tiện lợi, và phù hợp với mọi môi trường làm việc hiện đại.
                            <br><br>
                            </div>
                        </div>
                        <!--<h3>Hệ Điều Hành</h3>-->
                        ...
                        <div class="config-sections">
                            ...
                            <div class="config-section">
                                <h3>CPU</h3>
                                <div class="config-options">
                                    <?php foreach ($minipc_list as $index => $product): ?>
                                        <?php if (!empty($product->popup)): ?>
                                            <div class="modal fade" id="popup-minipc-<?= $index ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content"><?= $product->popup ?></div>
                                                </div>
                                            </div>
                                            <?php $detailButton = "<div class='detail-button-wrapper'><a href='#' data-toggle='modal' data-target='#popup-minipc-{$index}'>Chi Tiết</a></div>"; ?>
                                        <?php else: ?>
                                            <?php $detailButton = ''; ?>
                                        <?php endif; ?>
...
<script>
    ...
    <div class="specs-container">
        ...
        <h2>Tổng Quan Sản Phẩm</h2>
            <p style="color:black;">
                ROSA NUC13 PC là sự lựa chọn hoàn hảo cho môi trường văn phòng và các nhu cầu đa mục đích, nhờ vào sự kết hợp giữa tính linh hoạt và hiệu suất mạnh mẽ từ các tùy chọn CPU mới nhất. Với Intel Core i3-1315U, máy đáp ứng tốt các công việc văn phòng cơ bản và duyệt web hiệu quả. Intel Core i5-1340P cung cấp hiệu suất đa nhiệm ấn tượng, lý tưởng cho các tác vụ văn phòng nâng cao như xử lý dữ liệu và làm việc với nhiều ứng dụng cùng lúc. Đối với những công việc yêu cầu xử lý phức tạp, Intel Core i7-1360P mang đến sức mạnh vượt trội, phù hợp cho các tác vụ sáng tạo và các ứng dụng chuyên sâu.
                <br>
                Thiết kế nhỏ gọn của NUC13 giúp tiết kiệm không gian làm việc, trong khi khả năng kết nối hiện đại hỗ trợ các thiết bị ngoại vi và mạng nhanh chóng. Với ROSA NUC13 PC, bạn sẽ có một hệ thống tối ưu, dễ sử dụng, và lý tưởng cho mọi môi trường làm việc hiện đại.
            </p>
        </div>
    </div>

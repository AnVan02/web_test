...
$thumbnail1 = "/assets/images/case_cmp_right.jpg";
$thumbnail2 = "/assets/images/case_cmp_inside.jpg";
$thumbnail3 = "/assets/images/case_cmp_front.jpg";

// Create CPU list
$cpu_list = [$amd_ryzen5_5600x];

// Create VGA list
$vga_list = [$asus_4060,$powercolor_7600xt,$asus_4070,$asus_4070ti];

// Create MAINBOARD list
$main_list = [$asus_prime_b550];

// Create RAM list
$ram_list = [$kingston_8gx2_3200,$kingston_16gx2_3200,$gskill_32gx2_3600];
...
$coolerplus_key_mouse->sub_note = "🎁 Tặng kèm";
...
$others->price += 448; // extra


// Default cart (Giỏ hàng mặc định)
$cart_list = [$amd_ryzen5_5600x, // CPU
              $asus_prime_b550,  // MAIN
              $asus_4060,// VGA
              $kingston_8gx2_3200, // RAM
              $lexar_512g_m2,  // SSD
                ...
                .spec-name {
                    ...
                    <div class="product-column product-config">
                        <div class="product-header">
                            ...
                            <div>
                            <strong>PC mạnh mẽ cho game thủ đỉnh cao!</strong>
                            <br>
                            Với các tùy chọn VGA hàng đầu như <b>RTX4060, RTX4070, RTX4070TI và RX7600XT</b>, ROSA GAMER Ⅰ mang đến hiệu suất đồ họa vượt trội, sẵn sàng chinh phục mọi tựa game từ eSports đến AAA.
                            <br>
                            Đặc biệt, <b>Windows 11 Pro</b> được cài đặt sẵn trên máy giúp nâng cao trải nghiệm chơi game:
                            <dl>
                                <dt>🔥 Đồ họa đỉnh cao</dt>
                                <dd>Hỗ trợ DirectX 12 Ultimate và công nghệ Ray Tracing, khai thác tối đa sức mạnh của VGA để tạo ra hình ảnh sống động, chân thực.</dd>
                                <dt>🔥 Tốc độ vượt trội</dt>
                                <dd>Tận dụng DirectStorage, giảm thời gian tải game đáng kể để bạn vào trận ngay lập tức.</dd>
                                <dt>🔥 Tối ưu hiệu suất</dt>
                                <dd>Chế độ Game Mode ưu tiên tài nguyên cho game, mang lại trải nghiệm mượt mà, không giật lag.</dd>
                                <dt>🔥 Kết nối an toàn</dt>
                                <dd>Bảo mật mạnh mẽ giúp bạn yên tâm khi chơi game online.</dd>
                            </dl>
                            Với ROSA GAMER Ⅰ, bạn không chỉ chơi game, mà còn trải nghiệm thế giới gaming một cách đẳng cấp!
                            <br><br>
                            </div>
                        </div>
                        <!--<h3>Hệ Điều Hành</h3>-->
...
<script>
    ...
    <div class="specs-container">
        ...
        <h2>Tổng Quan Sản Phẩm</h2>
            <p style="color:black;">ROSA được trang bị các cấu hình mạnh mẽ để mang lại hiệu suất tối ưu cho các game thủ. Với các lựa chọn VGA cao cấp như RTX4060 O8G, RX7600XT 16G, RTX4070 012G và RTX4070TI SUPER O16G, bạn có thể dễ dàng trải nghiệm các tựa game AAA với đồ họa tuyệt đẹp và hiệu suất mượt mà. Tùy chọn RAM từ 16GB đến 64GB đảm bảo bạn có đủ bộ nhớ cho mọi nhu cầu đa nhiệm và game nặng.</p>
            <p style="color:black;">Với SSD dung lượng 512GB, 1TB hoặc 2TB, bạn có thể cài đặt từ 5 đến hơn 40 tựa game AAA mà không lo thiếu không gian, đồng thời tận hưởng tốc độ tải game nhanh chóng và khả năng truy xuất dữ liệu liền mạch. Hệ thống này giúp bạn chơi game ở độ phân giải cao, từ Full HD đến 4K, và đảm bảo bạn có thể chạy các ứng dụng cùng lúc mà không ảnh hưởng đến hiệu suất.</p>
            <p style="color:black;">Dù bạn là người chơi thông thường hay yêu thích chơi game với đồ họa đỉnh cao, Máy tính Gaming ROSA sẽ mang đến cho bạn trải nghiệm tuyệt vời và khả năng xử lý vượt trội.</p>

         
            <h3>Nâng Tầm Trải Nghiệm Gaming với DLSS và FRS</h3>
            <img src="../assets/images/dlss_fsr.jpg" alt="PC Gaming XYZ" style="width: 100%; max-width: 500px; display: block; margin: 20px auto;">

            <p style="color:black;">DLSS (Deep Learning Super Sampling) và FSR (FidelityFX Super Resolution) là hai công nghệ giúp cải thiện hiệu suất và chất lượng hình ảnh trong game, đặc biệt khi chơi ở độ phân giải cao. DLSS, phát triển bởi NVIDIA, sử dụng AI và học sâu để tái tạo hình ảnh chất lượng cao từ độ phân giải thấp, giúp giảm tải cho GPU mà không làm giảm chất lượng hình ảnh. Công nghệ này chỉ hoạt động trên các GPU RTX của NVIDIA. </p>

                ...
                <div class="card-body">
                    <div class="card-content">
                        ...
                        <div class="input-item form-group">
                            ...
                            <textarea name="article_content"img src="assets/uploads/news <?php echo $row['article_image'] ?>" class="article__image w-100 h-100" style="width: 50px; height: 50px;" alt="image"></textarea>

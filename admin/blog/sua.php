...
?>
    <form method="POST" action="admin/blog/xuly.php?article_id=<?php echo $row['article_id'] ?>" enctype="multipart/form-data">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="input-item form-group">
                            ...
                            <img src="admin/blog/uploads/<?php echo $row['article_image'] ?>" class="article__image w-100 h-100" style="width: 50px; height: 50px;" alt="image">
...
<script>
    ...
    function getCheckedCheckboxes() {
        ...
        btnAccept.href = "admin/blog/xuly.php?&article_id=<?php echo $_GET['article_id'] ?>&acceptcomment=1&data="+ JSON.stringify(checkedComment);
        btnDelete.href = "admin/blog/xuly.php?&article_id=<?php echo $_GET['article_id'] ?>&deletecomment=1&data="+ JSON.stringify(checkedComment);
    }
</script>
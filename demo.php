        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                function printRow($label, $value) {
                    if (!empty(trim($value)) && strtoupper(trim($value)) !== "N/A" && strtoupper(trim($value)) !== "NULL") {
                ...
                echo '<tr><td colspan="2" style="color:rgb(3, 0, 182);"><strong>Linh kiện và phụ kiện</strong></td></tr>';

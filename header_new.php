...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="header-top">
        <div class="logo_brand">
            ...
            <div class="brand_text">SỨC MẠNH CÔNG NGHỆ - VỮNG BƯỚC TƯƠNG LAI</div>
        </div>
    ...
    <header class="header">
        <div class="container d-flex align-items-center justify-content-between py-2">
            ...
            <nav class="nav_container d-none d-md-block">
                <ul class="d-flex">
                    <li><a id="home" href="index.php">TRANG CHỦ</a></li>
                    <li><a id="about" href="aboutus.php">GIỚI THIỆU</a></li>
                    <li><a id="products" href="product.php">SẢN PHẨM</a></li>
                    <li><a id="" href="#">Ứng Dụng ROSA <i class="fas fa-chevron-down" style="margin-left: 15px"></i></a>
                        <!-- <ul class="submenu">
                    ...
                    <li><a id="news" href="tintuc.php">TIN TỨC</a></li>
                    <li><a id="" href="check.php">KIỂM TRA ĐƠN HÀNG</a></li>
                    <li><a id="" href="baohanh_test.php">BẢO HÀNH</a></li>
                </ul>
            </nav>
    ...
    function loadLanguage(lang) {
        fetch("translations.json")
            ...
            .then(data => {
                ...
                document.getElementById("news").innerText = data[lang]["news"];
